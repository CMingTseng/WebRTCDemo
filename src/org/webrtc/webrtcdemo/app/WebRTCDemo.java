...
package org.webrtc.webrtcdemo.app;

import org.webrtc.webrtcdemo.MediaEngine;
import org.webrtc.webrtcdemo.MenuStateProvider;
import org.webrtc.webrtcdemo.NativeWebRtcContextRegistry;
import org.webrtc.webrtcdemo.R;
...
public class WebRTCDemo extends Activity implements MenuStateProvider {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mediaEngine.setAudio(getResources().getBoolean(R.bool.audio_enabled_default));
        mediaEngine.setAudioCodec(mediaEngine.getIsacIndex());
        mediaEngine.setAudioRxPort(getResources().getInteger(R.integer.aRxPortDefault));
        mediaEngine.setAudioTxPort(getResources().getInteger(R.integer.aTxPortDefault));
        mediaEngine.setSpeaker(getResources().getBoolean(R.bool.speaker_enabled_default));
        mediaEngine.setDebuging(getResources().getBoolean(R.bool.apm_debug_enabled_default));
        ...
        Tab tab = actionBar.newTab().setText("Main")
                .setTabListener(new TabListener<MainMenuFragment>(this, "main", MainMenuFragment.class));
        actionBar.addTab(tab);

        tab = actionBar.newTab().setText("Settings")
                .setTabListener(new TabListener<SettingsMenuFragment>(this, "Settings", SettingsMenuFragment.class));
        actionBar.addTab(tab);

        tab = actionBar.newTab().setText("Audio")
                .setTabListener(new TabListener<AudioMenuFragment>(this, "Audio", AudioMenuFragment.class));
        actionBar.addTab(tab);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.action_exit:
            MainMenuFragment main = (MainMenuFragment) getFragmentManager().findFragmentByTag("main");
            main.stopAll();
            finish();
            return true;
        default:
