...
class MediaCodecVideoDecoder {
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                ...
                case DECODE:
                    ...
                    handler.sendMessageDelayed(handler.obtainMessage(DECODE), delayMillis);
                    break;
                default:
                    break;
                }
    ...
    // Entry point from the native layer. It pushes the raw buffer to this
    // class.
    ...
    private boolean feedInputBuffer() {
        ...
        check(codecData.capacity() >= buffer.capacity(), "Buffer is too small to copy a frame.");
        buffer.rewind();
        codecData.rewind();
        ...
        try {
            int offset = 0;
            int flags = 0;
            codec.queueInputBuffer(index, offset, buffer.capacity(), frame.timestampUs, flags);
    ...
    // Returns true if more output data could be drained.MediaCodec has more
    // data
    // to deliver.
